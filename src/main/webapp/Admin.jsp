...
<div class="navbar">
		...
		<a href="#news">About</a>
		<a href="forgotAdminPassword">Change Password</a>
		<a href="leaveDetails">Doctor's Leave</a>
		<a href="adminLogout" style="padding-left:65%;">Logout</a>
	</div>
	<br>
<h3>${message}</h3>
...
<br>
<br>
<a type="button" href="ViewAllDoctor" class="btn btn-primary btn-lg">View all Doctors</a>
</div>
</center>
</body>
</html>